"""
Django settings for late_wave_43217 project.
...
ROOT_URLCONF = 'late_wave_43217.urls'
...
WSGI_APPLICATION = 'late_wave_43217.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "late_wave_43217 API",
    "DESCRIPTION": "API documentation for late_wave_43217 App",
    "VERSION": "v1",
}
